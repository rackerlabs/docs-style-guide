...
html_title = 'Rackspace Style Guide for Technical Content'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Style Guide'
...
latex_documents = [
  (master_doc, 'docs-style-guide.tex',
...
man_pages = [
    (master_doc, 'Rackspace Style Guide for Technical Content',
...
texinfo_documents = [
  (master_doc, 'docs-style-guide', 'Rackspace Technical Style Guide',
   'Rackspace', 'docs-style-guide', 'Learn about using the Product',
   'Miscellaneous'),
]
