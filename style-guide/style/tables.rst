...
Example tables that reflect the guidelines are presented in a separate section
at the end of this topic.

.. note::

   Don't create tables that are overly complex or that scroll horizontally. If
   a table has too much information, try to break it up into smaller tables.
...
-  When showing a notation (for example, a note or warning) in a table, use the
   guidelines in :ref:`notations`.
