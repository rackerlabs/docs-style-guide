...
.. list-table::
   ...
   * - Use
     - Don't use
   * - For details, see the client library documentation for the language
       you're interacting with.
     - For details, see the client library documentation for the language with
       which you're interacting.
...
.. list-table::
   ...
   * - Use
     - Don't use
   * - The icon for the connector manager turns green within a few minutes,
       and the connector instance is displayed shortly after.
     - The icon for the connector manager turns green within a few minutes
       after which the connector instance is displayed.
