...
-  If there is no style or element, or if you are showing the notation in a
   table cell, create the notation as follows: Type the word **Important**,
   **Note**, **Tip**, or **Warning**, make the word bold, follow it with a
   colon, and then provide the text of the notation in regular font.
